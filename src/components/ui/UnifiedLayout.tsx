...
import { User, FileText, Briefcase, PlusCircle, Eye, Edit2 } from 'lucide-react'
...
export default function UnifiedLayout({ children }: UnifiedLayoutProps) {
    ...
    const shouldShowNavAndSidebar = pathname === '/profile' || pathname.includes('/edit')
        ...
        <>
            ...
            <div className="flex flex-col min-h-screen max-h-screen">
                ...
                <div className="flex flex-1 overflow-hidden">
                    {shouldShowNavAndSidebar && pathname.includes('/edit') && (
                        <nav className={`

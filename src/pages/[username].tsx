...
export default function PublicProfile({ profileData }: PublicProfileProps) {
    ...
    const fetchExperienceItems = async () => {
        try {
            ...
            if (response.ok) {
                ...
                console.error('Failed to load experience items');
            }
        } catch (error) {
    ...
    return (
        ...
        >
                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 lg:gap-8 lg:items-center">
                    ...
                    <div className="flex flex-col lg:flex-row items-center gap-6 lg:col-span-9">
                        <motion.img 
                            ...
                            className="w-full h-auto lg:w-[19rem] lg:h-[19rem] 2xl:w-[21rem] 2xl:h-[21rem] rounded-3xl object-cover"
            ...
            <motion.hr 
                className='border-t-[3px] border-gray-400/10 my-8'
                initial={{ opacity: 0 }}
                animate={{ opacity: 1 }}

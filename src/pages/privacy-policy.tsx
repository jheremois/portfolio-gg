  ...
  return (
    <div className="min-h-screen bg-gray-50 py-10 px-5">
      ...
      <div className="max-w-4xl mx-auto bg-white shadow-md rounded-lg p-8">
        ...
        <p className="text-gray-500 text-sm mb-8">Last updated: {currentDate}</p>
        ...
        <section className="mb-8">
          ...
          <h3 className="text-xl font-semibold text-gray-700 mb-2">2.2. Usage Information:</h3>
          <ul className="list-disc ml-6 text-gray-600 mb-4">
            <li>IP address</li>
            <li>Browser type</li>
            <li>Pages visited</li>
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-semibold text-gray-700 mb-4">4. Sharing of Your Information</h2>
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-semibold text-gray-700 mb-4">6. Your Data Protection Rights</h2>
          <p className="text-gray-600 mb-4">

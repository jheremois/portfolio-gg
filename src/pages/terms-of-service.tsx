      ...
      <div className="max-w-4xl mx-auto bg-white shadow-md rounded-lg p-8">
        ...
        <section className="mb-8">
          ...
          <p className="text-gray-600">
            Welcome to Portfoliogg ("we," "our," or "us"). By accessing or using our website, located at <a href="https://www.portfoliogg.com/jheremois" className="text-blue-600 hover:underline">https://www.portfoliogg.com/jheremois</a>, you agree to comply with and be bound by these Terms of Service ("Terms"). If you disagree with any part of these Terms, you may not use our service.
          </p>
        </section>

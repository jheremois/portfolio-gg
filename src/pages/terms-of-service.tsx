    ...
    <>
      ...
      <div className="min-h-screen py-20 lg:px-5 px-2 text-text">
        ...
        <div className="container mx-auto rounded-lg p-8">
          ...
          <p className="text-gray-200 text-sm mb-8">Last updated: 6 October 2024</p>
          ...
          <section className="mb-8">
            ...
            <p className=" mb-4">3.1. You must create an account to use certain features of our service. You are responsible for maintaining the confidentiality of your account information and for all activities that occur under your account.</p>
            ...
            <p className=" mb-4">3.3. We reserve the right to suspend or terminate your account if any information provided during the registration process or thereafter proves to be inaccurate, not current, or incomplete.</p>
          </section>

          <section className="mb-8">
            <h2 className="text-2xl font-semibold mb-4">4. User Content</h2>
            <p className=" mb-4">4.1. You retain all rights to the content you upload to Portfoliogg ("User Content"). By uploading content, you grant us a non-exclusive, worldwide, royalty-free license to use, reproduce, adapt, publish, translate, and distribute it in any and all media.</p>
            <p className=" mb-4">4.2. You are solely responsible for your User Content and the consequences of posting or publishing it. You affirm, represent, and warrant that you own or have the necessary licenses, rights, consents, and permissions to publish the User Content you submit.</p>
            <p className=" mb-4">4.3. We reserve the right to remove any User Content that violates these Terms or is otherwise objectionable at our sole discretion.</p>
          </section>
          ...
          <section className="mb-8">
            ...
            <p className="">
              If you have any questions about these Terms, please contact us at <a href="mailto:info@geekguysstudio.com" className="text-blue-600 hover:underline">info@geekguysstudio.com</a>.
            </p>
          </section>
        </div>
      </div>
